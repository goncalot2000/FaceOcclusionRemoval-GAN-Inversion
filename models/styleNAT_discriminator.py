...
Slight changes to these have been made to include Spectral Norm.
StyleSwin changed the code to include this option.
'''
import math
import torch
...
from models.styleNAT_basiclayers import (Blur, Downsample, EqualConv2d, EqualLinear,
                                 ScaledLeakyReLU)
